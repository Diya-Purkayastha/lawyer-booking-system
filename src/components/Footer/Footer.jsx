        ...
        <div>
            <footer className="footer footer-horizontal footer-center bg-black text-white rounded p-10">
             <aside>
                ...
                <nav className="grid grid-flow-col gap-8 list-none text-gray-500">
                ...
                <nav>
                    ...
                    <a href='https://x.com/diyapurkaystha' target="_blank" >
                        <svg
                    ...
                    <a href='https://www.youtube.com/channel/UCqRz0V17_Yegj7kBHZQ9msw' target="_blank"  >
                        <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                    ...
                    <a href='https://www.facebook.com/priya.dp.9404' target="_blank" >
                        <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
